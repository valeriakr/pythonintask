...
TIE = "Ничья"
NUM_SQUARES = 9
WAYS_TO_WIN = ((4, 8, 0),# первый ход с центра поля
               (6, 2, 4),
               (6, 7, 8),
               (2, 1, 0),
                (3, 4, 5),
...
def display_instruct():
    ...
    print(
    """
    Добро пожаловать на ринг грандиознейших интеллектуальных состязанийех времен.
...
def pieces():
    ...
    if go_first == "да":
        print("\nНу что ж, даю тееб фору: играй крестиками.")
        human = X
        computer = O
    else:
