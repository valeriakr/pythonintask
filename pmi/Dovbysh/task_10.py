...
"""
          ...
          Сейчас вы сможете распределенить некоторое количество пунктов между несколькими характеристиками персонажа.
                 Чтобы добавить один пункт в характеристику, просто напишите название характеристики. 
	             Чтобы добавить сразу несколько пунктов, поставьте пробел и укажите количество пунктов.
                                    Например:
                                        "Мудрость" - добавит один пункт к Силе.
                                        "Мудрость 10" - добавит 10 пунктов к Силе.
				 ...
				 Чтобы удалить сразу несколько пунктов, поставьте пробел и укажите количество пунктов.
                                    Например:
                                        "-Сила" - уберет один пункт от Здоровья.
                                        "-Сила 10" - уберет 10 пунктов от Здоровья.
"""
)
